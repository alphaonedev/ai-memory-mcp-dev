...
| Refactor `db.rs` behind trait | 1–2 | Trait approved | `SqliteBackend` impl, all 33 public functions wrapped, 226 tests green |
...
| Integration test matrix | 1 | All backends | CI pipeline testing all backends against 226-test suite |
...
1. **226 existing tests green** — zero regression
