...
| Refactor `db.rs` behind trait | 1–2 | Trait approved | `SqliteBackend` impl, all 33 public functions wrapped, 223 tests green |
...
| Integration test matrix | 1 | All backends | CI pipeline testing all backends against 223-test suite |
...
1. **223 existing tests green** — zero regression
